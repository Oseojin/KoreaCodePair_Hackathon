...
value2 = st.sidebar.slider(label="Sepal width (cm)", min_value=0.0, max_value=8.0, value= 4.2)
value3 = st.sidebar.slider(label="Petal length (cm)", min_value=0.0, max_value=8.0, value= 3.2)
value4 = st.sidebar.slider(label="Petal width (cm)", min_value=0.0, max_value=8.0, value= 2.2)
